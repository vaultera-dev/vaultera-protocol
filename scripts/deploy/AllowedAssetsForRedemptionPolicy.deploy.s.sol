...
contract DeployAllowedAssetsForRedemptionPolicy is Script {
    ...
    function run() external returns (address) {
        ...
        // Instantiate the AllowedAssetsForRedemptionPolicy contract with the provided addresses
        AllowedAssetsForRedemptionPolicy policyContract =
            new AllowedAssetsForRedemptionPolicy(policyManagerAddress, addressListRegistryAddress);
