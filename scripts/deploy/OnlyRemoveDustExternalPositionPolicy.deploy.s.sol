...
contract DeployOnlyRemoveDustExternalPositionPolicy is Script {
    ...
    function run() external returns (address) {
        ...
        // Instantiate the OnlyRemoveDustExternalPositionPolicy contract with the provided constructor values
        OnlyRemoveDustExternalPositionPolicy policyContract = new OnlyRemoveDustExternalPositionPolicy(
