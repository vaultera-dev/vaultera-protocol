...
import "./../../contracts/release/extensions/fee-manager/fees/ManagementFee.sol";
import "forge-std/console.sol";
import "./Addresses.sol";

contract DeployManagementFee is Script {
    ...
    function run() external returns (address) {
        ...
        // Instantiate the ManagementFee contract with the FeeManager address
        ManagementFee feeContract = new ManagementFee(feeManagerAddress);
